...
public section.
  ...
  end of TS_OVCABECALHO .
  types:
TT_OVCABECALHO type standard table of TS_OVCABECALHO .
  types:
  ...
  begin of TS_OVITEM,
     ...
     PRECOTOTAL type P length 8 decimals 2,
  end of TS_OVITEM .
  types:
...
TT_MENSAGEM type standard table of TS_MENSAGEM .
  ...
  constants GC_OVCABECALHO type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'OVcabecalho' ##NO_TEXT.
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            ...
                            iv_left_type        = 'OVcabecalho' "#EC NOTEXT
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'CabItemSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'OVcabecalhoSet'              "#EC NOTEXT
...
* Navigation Properties for entity - OVcabecalho
lo_entity_type = model->get_entity_type( iv_entity_name = 'OVcabecalho' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'OVcabecalho' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZOV_MPC=>TS_OVCABECALHO' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'OVcabecalhoSet' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PrecoTotal' iv_abap_fieldname = 'PRECOTOTAL' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250317154122'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'OVcabecalho'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'PrecoTotal'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'OVitem'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
